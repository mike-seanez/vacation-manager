    ...
    <div className="bg-card rounded-lg border border-border p-6 shadow-elevation-1">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="bg-muted rounded-lg p-4">
          ...
          <p className="text-2xl font-bold text-success">{earnedDays}</p>
        </div>
        ...
        <div className="bg-muted rounded-lg p-4">
          ...
          <p className="text-2xl font-bold text-warning">{usedDays}</p>
        </div>
        ...
        <div className="bg-muted rounded-lg p-4">
          ...
          <p className="text-2xl font-bold text-accent">{pendingDays}</p>
        </div>
        ...
        <div className="bg-primary/10 rounded-lg p-4 border border-primary/20">
          ...
          <p className="text-3xl font-bold text-primary">{availableDays}</p>
        </div>
      </div>
